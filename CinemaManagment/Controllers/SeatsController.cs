...
namespace CinemaManagment.Controllers
{
    ...
    public class SeatsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,SeatNumber,IsTaken")] Seat seat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,SeatNumber,IsTaken")] Seat seat)
        {
            if (id != seat.Id)
            {
                return NotFound();
